...
export default function ApplyPage() {
  ...
  const [documents, setDocuments] = useState<{ name: string; type: string; file: File | null }[]>([
    { name: "", type: "institute_id", file: null },
    { name: "", type: "parent_letter", file: null },
    { name: "", type: "confirmation_letter", file: null },
  ])
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
                ...
                >
                  <div className="flex items-start space-x-3 rounded-lg border p-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        No financial support OR less than Rs. 10,000/month
                      </p>
                      <p className="text-sm font-medium text-primary mt-1">
                        Rs. 150/day (Max Rs. 3000/month)
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3 rounded-lg border p-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Financial support of Rs. 10,000/month or more
                      </p>
                      <p className="text-sm font-medium text-primary mt-1">
                        Rs. 200/day (Max Rs. 4000/month)
                      </p>
                    </div>
                  </div>
                </RadioGroup>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-3">
                  {[
                    { type: "institute_id", label: "Institute ID Card" },
                    { type: "parent_letter", label: "Official Letter from Parent Institute" },
                    { type: "confirmation_letter", label: "IIT Ropar Confirmation Letter" },
                  ].map((doc, index) => (
