...
export default async function JSReviewPage({
  params,
}: {
  ...
  const application = await prisma.application.findUnique({
    where: { id, status: 'PENDING_HOSTEL_REVIEW' },
  })
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div>
          ...
          <p className="text-muted-foreground mt-2">
            Junior Superintendent Review Stage
          </p>
        </div>
        ...
        <ApprovalForm
          ...
          actions={[
            { value: 'PROCEED_TO_ALLOCATION', label: 'Proceed to Allocation', icon: 'forward' },
            { value: 'SENT_BACK', label: 'Send Back to Applicant', variant: 'secondary', icon: 'back' },
          ]}
